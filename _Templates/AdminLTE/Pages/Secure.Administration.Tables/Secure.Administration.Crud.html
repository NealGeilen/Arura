    ...
    <div class="card-header">
        ...
        <div class="card-tools">
            <div class="btn-group btn-group-sm">
                ...
                {if $aTable.Table_Owner_User_Id == $aUser.User_Id}<a class="btn btn-primary" title="Instellingen" href="/{$aArura.dir}/administration?s={$aTable.Table_Id}"><i class="fas fa-cogs"></i></a>{/if}
            </div>
            {if $bCanExport}
