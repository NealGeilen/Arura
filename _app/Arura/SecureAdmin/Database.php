...
class Database extends \NG\Database {
    ...
    public function createRecord($sTable, $aData)
    {
        ...
        foreach ($aData as $sField => $sValue){
            $aList[$sField] = $this->encrypt($sValue);
        }
        return parent::createRecord($sTable, $aList); // TODO: Change the autogenerated stub
    }
    ...
    public function updateRecord($sTable, $aData, $sPrimaryKey)
    {
        ...
        return parent::updateRecord($sTable, $aList, $sPrimaryKey); // TODO: Change the autogenerated stub
    }
